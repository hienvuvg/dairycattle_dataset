...
def cam_crop(combined_timestamps, cam_id):
...
if __name__ == '__main__':
    ...
    # behav_dir = file_dirs['behav_dir']
    # label_dir = file_dirs['label_dir']
    # label_dir = os.path.join(label_dir, set)
    ...
    func = partial(cam_crop, combined_timestamps)
    ...
    if len(cam_list) > 1:
        ...
        for cam_id in cam_list:
            cam_crop(combined_timestamps, cam_id)
