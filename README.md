...
Note:
* As of 6/6/2024, all four scripts are working but only the training and testing of the RGBs vision model has not been incorporated into ```train_test_all_moda.sh```
