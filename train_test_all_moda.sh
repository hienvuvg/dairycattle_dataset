...
# @Last Modified time: 2024-06-07 12:32:12
...
$python_cmd ./benchmarks/1_behavior_cls/uwb_hd_aa/train_uwb_hd_akl_s1.py --path_dir "$YAML_DIR" --config_dir "$S1_JSON_DIR"
$python_cmd ./benchmarks/1_behavior_cls/uwb_hd_aa/train_uwb_hd_akl_s2.py --path_dir "$YAML_DIR" --config_dir "$S2_JSON_DIR"
