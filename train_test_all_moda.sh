...
$python_cmd ./benchmarks/1_behavior_cls/uwb_hd_aa/train_uwb_hd_aa_s1.py --path_dir "$YAML_DIR" --config_dir "$S1_JSON_DIR"
$python_cmd ./benchmarks/1_behavior_cls/uwb_hd_aa/train_uwb_hd_aa_s2.py --path_dir "$YAML_DIR" --config_dir "$S2_JSON_DIR"
