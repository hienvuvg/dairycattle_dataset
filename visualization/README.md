...
## UWB Localization
Localization of a single cow using UWB (does not require the visual data):
```
...
Localization of cows (from 1 to 16) simultaneously using multiple views. Only applicable to 7/25 (does not require the visual data):
```
